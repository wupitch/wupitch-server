...
@NoArgsConstructor
@AllArgsConstructor
public class ProfileImpromptuListRes implements Comparable<ProfileImpromptuListRes>{
    ...
    public ProfileImpromptuListRes(Impromptu impromptu) {
    ...
    @Override
    public int compareTo(@NotNull ProfileImpromptuListRes other) {
        return Integer.compare(other.dDay, this.dDay);
    }
}
