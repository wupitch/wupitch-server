...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.PATCH, "/app/accounts/invalid-status/{email}","/app/accounts/auth/{accountId}/enrollment-agree","/app/accounts/auth/{accountId}/enrollment-deny").permitAll()
